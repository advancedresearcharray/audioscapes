...
def build_parser() -> argparse.ArgumentParser:
    ...
    sm.add_argument("--max-energy-step", type=float, default=2.0, help="Max Mixed In Key energy jump 1–10 (default: 2)")
    ...
    sm.add_argument("--keep-order", action="store_true", help="Keep recorded order instead of Mixed In Key / energy picking")
