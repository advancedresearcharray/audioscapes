...
It equalizes, compresses, and lifts buried low, mid, and high so thin tracks fill out. You get a 16-band graphic EQ with a live analyzer and AUTO, plus LOW / MID / HIGH / GAIN knobs with **TONE** profiles (including **80s POP** and **AUTO**). **TONE AUTO** and **EQ AUTO** ride together every beat: they detect what the track wants (club, voice, thin, rock, and more) and ease both the shelves and the graphic EQ that way. The 310 POWER row is a fluorescent VFD ticker with LIVE / AUTO lamps; tempo is a 7-segment BPM counter on the unit header. Dynamics, FX, output routing, and a cassette-style deck are in the same rack. Closing the panel does not stop processing.
...
**LOW / MID / HIGH / GAIN** on the 310 have their own **TONE** profiles (80s POP, Disco, Rock, Ballad, Club, Night, Voice, AUTO). **80s POP** is +8 low, +6 mid, +2 high, +6 gain. **AUTO** is the ride preset: it turns on TONE AUTO and EQ AUTO together. Every beat they read the spectrum and BPM, guess what the music wants (thin, club, disco, voice, bright, ballad, rock, or a full mix), and ease the shelves plus the 16-band graphic that way — smooth slews, light glue compression, pull-back only when the ceiling is close. Intent shows on the VFD ticker; BPM is the 7-segment readout on the 310 header. Twist a knob or press AUTO again to stop both.
